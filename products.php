...
<body class="bg-gray-100">
    ...
    <section class="bg-gray-700">
        ...
        <h1 class="text-3xl text-white font-semibold mb-4">Posts</h1></div>
        <div class="grid grid-cols-1 gap-10">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<p class="text-black font-bold">Author : '.$row['username'].', Posted at- '.$row['c_time'].'</p>';
                if (strcmp($row['e_time'],$row['c_time'])===1) {
                echo '<p class="text-black font-bold">Reposted at- '.$row['e_time'].'</p>';
                }
                ...
                echo '<textarea name="comment" class="w-full p-2 border-0" placeholder="Add a comment..."></textarea>';
